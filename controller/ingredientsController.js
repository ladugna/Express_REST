...
module.exports.addNewIngredients = async (req, res, next) => {
    try {
        ...
        ingredientsModel[mealIndex].ingredients = [...ingredientsModel[mealIndex]
...
module.exports.updateIngredients = async (req, res, next) => {
    try {
        ...
        ingredientsModel[mealIndex].ingredients = ingredientsModel[mealIndex].ingredients
            .map(ingredients => {
                if (ingredients.id === ingredients_id)
                    return updatedIngredients;
                //return [...ingredientsModel[mealIndex].ingredients, ...updatedIngredients]
                else
                    return ingredients;
            })
...
module.exports.getIngredientsById = async (req, res, next) => {
    try {
        ...
        res.json(ingredientsModel[mealIndex]);
    } catch (error) {
        next(error)
